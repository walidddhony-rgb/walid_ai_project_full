...
1. Replace the stub model callback with a real Ollama chat service.
2. Move voice operations to background workers integrated with Qt signals.
3. Add unit tests for `DatabaseManager`, `PermissionManager`, and `ChatService`.
4. Introduce structured logging across all modules.
5. Add settings management for model, language, and workspace preferences.
